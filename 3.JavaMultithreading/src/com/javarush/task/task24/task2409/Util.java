    ...
    public static List<Jeans> getAllJeans() {
        ...
        //add your code here
         abstract class AbstractJeans implements Jeans{
             ...
             private int id, size, length;
             private double price;

             public AbstractJeans(int id, int size, int length, double price) {
                 this.id = id;
                 this.size = size;
                 this.length = length;
                 this.price = price;
            ...
            public String toString() {
                return this.getClass().getSimpleName() + String.format(Locale.ENGLISH, "{id=%d, length=%d, size=%d, price=%.1f}", this.getId(), this.getLength(), this.getSize(), this.getPrice());
            }
        ...
        class Denim extends AbstractJeans{
            public Denim(int id, int size, int length, double price) {
                super(id, size, length, price);
            }
        ...
        class Levis extends AbstractJeans{
            public Levis(int id, int size, int length, double price) {
                super(id, size, length, price);
            }
